...
pass(packageJson.version === '1.8.0', 'A Fase 7 deve identificar o pacote 1.8.0.');
...
pass(continuity.includes('próximo vestígio explicado') && continuity.includes('fragmento que reaparece'), 'A recomendação explicada ou o reaparecimento de fragmentos está ausente.');
pass(continuity.includes('entry.dominant.id === primary') && continuity.includes('entry.secondary.id === primary'), 'A recomendação não considera Fervores dominante e secundário.');
